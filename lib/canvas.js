...
function startGame() {
  ...
  $('.info').show();
  animate();
  fruitsInterval = setInterval(fruitsGoLeft, 1300);
...
function animate(){
  ...
  foreground();
  ctx.fillText("Score", 310, 100);
  ctx.fillText(`${score}`, 323, 120);
  ctx.fillText("Timer", 310, 150);
  ctx.fillText(`${Math.floor(time/100)}`, 323, 170);
  time--;
  new Players();
